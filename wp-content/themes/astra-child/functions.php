                        ...
                        <div class="form-group">
                            <div class="location-search-group p-relative">
                                ...
                                <button type="button" style="display:none"
                                        class="btn btn-primary btn-generate-prayer btn-generate-prayer-times-js"
                                        id="search-btn">
                                    SEARCH
                                </button>
                            </div>
                ...
                <div class="prayer-time-box section-design">
                    ...
                    <div class="row">
                        <div class="col-sm-4 text-left">
                            <label class="m-0" style="color:#000000; margin-bottom:0; font-size:16px;">Calculation
                                Method</label>
                            <span class="tooltip">
                        ...
                        <div class="col-sm-3 text-left">
                            <label class="m-0" style="color:#000000; margin-bottom:0; font-size:16px;">Juristic
                                Method</label>
                            <span class="tooltip">
                            <i class="fa fa-info-circle" style="color: #363636; font-size:16px;" aria-hidden="true"></i>
